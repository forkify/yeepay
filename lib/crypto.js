...
function getRSASign(obj,merchantPrivateKey,algorithm){
	...
	var pem = getRSAPrivateKey(merchantPrivateKey.substring(0, 16));
console.log(merchantPrivateKey)
console.log(merchantPrivateKey.substring(0, 16))
console.log(valStr)
	RSA.update(valStr, 'utf8');	
console.log(2323, RSA.sign(pem,'base64'));
